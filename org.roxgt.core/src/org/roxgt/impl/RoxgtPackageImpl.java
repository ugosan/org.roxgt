 ...
 * @generated
 */
public class RoxgtPackageImpl extends EPackageImpl implements RoxgtPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.roxgt.RoxgtPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RoxgtPackageImpl() {
		super(eNS_URI, RoxgtFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static RoxgtPackage init() {
		if (isInited) return (RoxgtPackage)EPackage.Registry.INSTANCE.getEPackage(RoxgtPackage.eNS_URI);

		// Obtain or create and register package
		RoxgtPackageImpl theRoxgtPackage = (RoxgtPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof RoxgtPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new RoxgtPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRoxgtPackage.createPackageContents();

		// Initialize created meta-data
		theRoxgtPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRoxgtPackage.freeze();

		return theRoxgtPackage;
	}
	 ...
	 * @generated
	 */
	public RoxgtFactory getRoxgtFactory() {
		return (RoxgtFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGraphElement_Label(), ecorePackage.getEString(), "label", null, 0, 1, GraphElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGraphElement_Properties(), this.getProperty(), null, "properties", null, 0, -1, GraphElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
