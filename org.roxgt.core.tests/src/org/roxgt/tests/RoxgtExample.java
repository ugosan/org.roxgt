...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>roxgt</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RoxgtExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(RoxgtPackage.eNS_URI, 
			 RoxgtPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.roxgt"));
				Graph root = RoxgtFactory.eINSTANCE.createGraph();
