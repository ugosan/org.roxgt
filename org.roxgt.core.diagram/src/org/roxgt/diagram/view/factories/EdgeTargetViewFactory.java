 ...
 * @generated
 */
public class EdgeTargetViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = RoxgtVisualIDRegistry
					.getType(EdgeTargetEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				RoxgtVisualIDRegistry.getType(EdgeLabel2EditPart.VISUAL_ID),
