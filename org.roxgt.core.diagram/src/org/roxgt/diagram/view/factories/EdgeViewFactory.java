 ...
 * @generated
 */
public class EdgeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (!GraphEditPart.MODEL_ID.equals(RoxgtVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", GraphEditPart.MODEL_ID); //$NON-NLS-1$
		...
		getViewService().createNode(eObjectAdapter, view,
				RoxgtVisualIDRegistry.getType(EdgeLabelEditPart.VISUAL_ID),
