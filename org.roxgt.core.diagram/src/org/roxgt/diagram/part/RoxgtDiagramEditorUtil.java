 ...
 * @generated
 */
public class RoxgtDiagramEditorUtil {
		...
		try {
			...
			MessageDialog
					.openError(
							...
							NLS
									.bind(
											Messages.RoxgtDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = RoxgtDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI,
		...
		progressMonitor.beginTask(
				Messages.RoxgtDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					...
					diagramResource
							.save(org.roxgt.diagram.part.RoxgtDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	...
	private static Graph createInitialModel() {
		return RoxgtFactory.eINSTANCE.createGraph();
	}
