...
import org.roxgt.diagram.edit.helpers.RoxgtBaseEditHelper;
import org.roxgt.diagram.part.RoxgtVisualIDRegistry;

/**
 * @generated
 */
public class RoxgtBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(RoxgtVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					RoxgtBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateEdge_3001(Graph container, Node source,
				Node target) {
		 ...
		 * @generated
		 */
		public static boolean canExistEdge_3001(Graph container, Node source,
				Node target) {
			return true;
		}
